...
import com.poks.par.mar.appp.databinding.FragmentWebViewBinding
import com.poks.par.mar.appp.util.ViewBindingFragment
import javax.inject.Inject

class PrivacyPolicyFragment : ViewBindingFragment<FragmentWebViewBinding>(FragmentWebViewBinding::inflate) {
  ...
  companion object {
    private const val TAG: String = "PrivacyPolicyFragment"
  }
}