...
import com.poks.par.mar.appp.databinding.FragmentLoadingBinding
import com.poks.par.mar.appp.util.ViewBindingFragment
import javax.inject.Inject

class LoadingFragment : ViewBindingFragment<FragmentLoadingBinding>(FragmentLoadingBinding::inflate) {
  ...
  companion object {
    private const val TAG: String = "LoadingFragment"
  }
}